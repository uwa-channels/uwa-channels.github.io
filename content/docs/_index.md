...
* A simple example of this process is given in `xxx.m`. Before running the example code, please read the corresponding `readme` file. Note that visualizing a channel requires considerable computer memory. 
